 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _u(t){let e=0;for(const n in t)Object.prototype.hasOwnProperty.call(t,n)&&e++;return e}function ds(t,e){for(const n in t)Object.prototype.hasOwnProperty.call(t,n)&&e(n,t[n])}function Id(t){for(const e in t)if(Object.prototype.hasOwnProperty.call(t,e))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gs{constructor(e,n){this.mapKeyFn=e,this.equalsFn=n,this.inner={},this.innerSize=0}get(e){const n=this.mapKeyFn(e),s=this.inner[n];if(s!==void 0){for(const[r,i]of s)if(this.equalsFn(r,e))return i}}has(e){return this.get(e)!==void 0}set(e,n){const s=this.mapKeyFn(e),r=this.inner[s];if(r===void 0)return this.inner[s]=[[e,n]],void this.innerSize++;for(let i=0;i<r.length;i++)if(this.equalsFn(r[i][0],e))return void(r[i]=[e,n]);r.push([e,n]),this.innerSize++}delete(e){const n=this.mapKeyFn(e),s=this.inner[n];if(s===void 0)return!1;for(let r=0;r<s.length;r++)if(this.equalsFn(s[r][0],e))return s.length===1?delete this.inner[n]:s.splice(r,1),this.innerSize--,!0;return!1}forEach(e){ds(this.inner,(n,s)=>{for(const[r,i]of s)e(r,i)})}isEmpty(){return Id(this.inner)}size(){return this.innerSize}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class F0{constructor(e){this.fe=e}}function U0(t){const e=R0({parent:t.parent,structuredQuery:t.structuredQuery});return t.limitType==="LAST"?ba(e,e.limit,"L"):e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $c{constructor(){this.fs=new $e(Ie.ds),this.ws=new $e(Ie._s)}isEmpty(){return this.fs.isEmpty()}addReference(e,n){const s=new Ie(e,n);this.fs=this.fs.add(s),this.ws=this.ws.add(s)}gs(e,n){e.forEach(s=>this.addReference(s,n))}removeReference(e,n){this.ys(new Ie(e,n))}ps(e,n){e.forEach(s=>this.removeReference(s,n))}Is(e){const n=new M(new ae([])),s=new Ie(n,e),r=new Ie(n,e+1),i=[];return this.ws.forEachInRange([s,r],o=>{this.ys(o),i.push(o.key)}),i}Ts(){this.fs.forEach(e=>this.ys(e))}ys(e){this.fs=this.fs.delete(e),this.ws=this.ws.delete(e)}Es(e){const n=new M(new ae([])),s=new Ie(n,e),r=new Ie(n,e+1);let i=G();return this.ws.forEachInRange([s,r],o=>{i=i.add(o.key)}),i}containsKey(e){const n=new Ie(e,0),s=this.fs.firstAfterOrEqual(n);return s!==null&&e.isEqual(s.key)}}class Ie{constructor(e,n){this.key=e,this.As=n}static ds(e,n){return M.comparator(e.key,n.key)||X(e.As,n.As)}static _s(e,n){return X(e.As,n.As)||M.comparator(e.key,n.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function no(t){return new I0(t,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qT(t,e,n){let s=1,r=null,i=null,o=!1,a=0;function c(){return a===2}let l=!1;function u(...S){l||(l=!0,e.apply(null,S))}function f(S){r=setTimeout(()=>{r=null,t(g,c())},S)}function p(){i&&clearTimeout(i)}function g(S,...q){if(l){p();return}if(S){p(),u.call(null,S,...q);return}if(c()||o){p(),u.call(null,S,...q);return}s<64&&(s*=2);let H;a===1?(a=2,H=0):H=(s+Math.random())*1e3,f(H)}let A=!1;function I(S){A||(A=!0,p(),!l&&(r!==null?(S||(a=2),clearTimeout(r),f(0)):S||(a=1)))}return f(0),i=setTimeout(()=>{o=!0,I(!0)},n),I}function HT(t){t(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
\r
`,p=`\r
--`+c+"--",g=Vt.getBlob(f,s,p);if(g===null)throw UT();const A={name:l.fullPath},I=al(i,t.host,t._protocol),S="POST",q=t.maxUploadRetryTime,j=new Yp(I,S,y1(t,n),q);return j.urlParams=A,j.headers=o,j.body=g.uploadData(),j.errorHandler=Jp(e),j}class b1{constructor(){this.sent_=!1,this.xhr_=new XMLHttpRequest,this.initXhr(),this.errorCode_=vn.NO_ERROR,this.sendPromise_=new Promise(e=>{this.xhr_.addEventListener("abort",()=>{this.errorCode_=vn.ABORT,e()}),this.xhr_.addEventListener("error",()=>{this.errorCode_=vn.NETWORK_ERROR,e()}),this.xhr_.addEventListener("load",()=>{e()})})}send(e,n,s,r){if(this.sent_)throw Is("cannot .send() more than once");if(this.sent_=!0,this.xhr_.open(n,e,!0),r!==void 0)for(const i in r)r.hasOwnProperty(i)&&this.xhr_.setRequestHeader(i,r[i].toString());return s!==void 0?this.xhr_.send(s):this.xhr_.send(),this.sendPromise_}getErrorCode(){if(!this.sent_)throw Is("cannot .getErrorCode() before sending");return this.errorCode_}getStatus(){if(!this.sent_)throw Is("cannot .getStatus() before sending");try{return this.xhr_.status}catch{return-1}}getResponse(){if(!this.sent_)throw Is("cannot .getResponse() before sending");return this.xhr_.response}getErrorText(){if(!this.sent_)throw Is("cannot .getErrorText() before sending");return this.xhr_.statusText}abort(){this.xhr_.abort()}getResponseHeader(e){return this.xhr_.getResponseHeader(e)}addUploadProgressListener(e){this.xhr_.upload!=null&&this.xhr_.upload.addEventListener("progress",e)}removeUploadProgressListener(e){this.xhr_.upload!=null&&this.xhr_.upload.removeEventListener("progress",e)}}class C1 extends b1{initXhr(){this.xhr_.responseType="text"}}function Zp(){return new C1}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tg="storage";function O1(t,e,n){return t=ht(t),A1(t,e,n)}function M1(t){return t=ht(t),S1(t)}function P1(t,e){return t=ht(t),R1(t,e)}function L1(t=mf(),e){t=ht(t);const s=df(t,tg).getImmediate({identifier:e}),r=of("storage");return r&&F1(s,...r),s}function F1(t,e,n,s={}){k1(t,e,n,s)}function U1(t,{instanceIdentifier:e}){const n=t.getProvider("app").getImmediate(),s=t.getProvider("auth-internal"),r=t.getProvider("app-check-internal");return new cl(n,s,r,e,pf)}function $1(){Hs(new Jn(tg,U1,"PUBLIC").setMultipleInstances(!0)),Wt(oh,ah,""),Wt(oh,ah,"esm2017")}$1();const B1={apiKey:"AIzaSyDyW77823MSajkNaSQ6fw9-u8JtbPD_D-E",authDomain:"fir-testing-53e54.firebaseapp.com",projectId:"fir-testing-53e54",storageBucket:"fir-testing-53e54.appspot.com",messagingSenderId:"530300578305",appId:"1:530300578305:web:594a5b6b3f79a5ad17ee00"};gf(B1);const ll=iT(),V1=L1();const j1={components:{Button:ec},emits:["add","close"],data(){return{name:null,winningYears:null}},methods:{async addTeam(){this.name=this.name.trim().substring(0,1).toUpperCase()+this.name.trim().substring(1).toLowerCase(),this.winningYears=this.winningYears.split(", "),this.winningYears=this.winningYears.map(r=>Number.parseInt(r));const t=this.$refs.inputFile.files[0],e=P1(V1,t.name);await O1(e,t);const n=await M1(e),s=Ep(ll,"teams");await IT(s,{logo:n,name:this.name,winningYears:this.winningYears}),this.name="",this.winningYears="",this.$refs.addFrom.reset(),this.$emit("add")},handleClose(){this.$emit("close")}}},ao=t=>(ar("data-v-6042371b"),t=t(),cr(),t),q1=ao(()=>ne("h2",null,"Add a new team",-1)),H1={class:"input-field"},z1=ao(()=>ne("label",{for:"name"},"Name:",-1)),K1={class:"input-field"},W1=ao(()=>ne("label",{for:"winningYears"},"Winning Years:",-1)),G1={class:"input-field-logo"},Q1=ao(()=>ne("label",{for:"logo"},"Logo:",-1)),Y1={ref:"inputFile",type:"file",accept:".webp",id:"logo",required:""};function X1(t,e,n,s,r,i){const o=$t("Button");return st(),It(He,null,[q1,ne("form",{onSubmit:e[3]||(e[3]=nf((...a)=>i.addTeam&&i.addTeam(...a),["prevent"])),ref:"addFrom"},[ne("div",H1,[z1,ni(ne("input",{"onUpdate:modelValue":e[0]||(e[0]=a=>r.name=a),id:"name",type:"text",required:"",placeholder:"e.g. Real Madrid"},null,512),[[ea,r.name]])]),ne("div",K1,[W1,ni(ne("input",{"onUpdate:modelValue":e[1]||(e[1]=a=>r.winningYears=a),id:"winningYears",type:"text",pattern:"\\d{4}(,\\s\\d{4})*",title:"e.g. 2022, 2023",required:"",placeholder:"e.g. 2022, 2023"},null,512),[[ea,r.winningYears]])]),ne("div",G1,[Q1,ne("input",Y1,null,512)]),we(o,{label:"add"}),ne("i",{class:"fa-solid fa-xmark",onClick:e[2]||(e[2]=(...a)=>i.handleClose&&i.handleClose(...a))})],544)],64)}const J1=bn(j1,[["render",X1],["__scopeId","data-v-6042371b"]]);const Z1={},eI={class:"modal"};function tI(t,e,n,s,r,i){return st(),It("dialog",eI,[Sm(t.$slots,"default",{},void 0,!0)])}const nI=bn(Z1,[["render",tI],["__scopeId","data-v-891e455d"]]);function sI(t){return t&&t.__esModule&&Object.prototype.hasOwnProperty.call(t,"default")?t.default:t}var ul={};Object.defineProperty(ul,"__esModule",{value:!0});var rI=function(){function t(e,n){for(var s=0;s<n.length;s++){var r=n[s];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(e,n,s){return n&&t(e.prototype,n),s&&t(e,s),e}}();function iI(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}var oI=function(){function t(){iI(this,t),this.view=document.body.appendChild(document.createElement("div")),this.view.classList.add("snackbar"),this.isActive=!1,this.queue=[],this.gap=250,this.duration=5e3}return rI(t,[{key:"show",value:function(n){var s=this;if(this.isActive){this.queue.push(n);return}this.isActive=!0,this.view.textContent=n,this.view.classList.add("snackbar--visible"),this.queue.shift(),setTimeout(function(){return s.hide()},this.duration)}},{key:"hide",value:function(){var n=this;this.isActive=!1,this.view.classList.remove("snackbar--visible"),this.queue.length&&setTimeout(function(){return n.show(n.queue[0])},this.gap)}}]),t}();ul.default=oI;var aI=ul,cI=lI(aI);function lI(t){return t&&t.__esModule?t:{default:t}}var Fo=void 0;function uI(){return Fo||(Fo=new cI.default),Fo}var hI=uI();const ng=sI(hI);const fI={components:{Button:ec},props:["deleteDoc"],emits:["cancel","confirm"],methods:{handleCancel(){this.$emit("cancel")},deleteTeam(){const t=Tp(ll,"teams",this.deleteDoc);this.$emit("confirm"),TT(t).then(()=>{ng.show("The team has been deleted successfully!")})}}},dI=t=>(ar("data-v-7ecd958b"),t=t(),cr(),t),pI=dI(()=>ne("h2",null,"Please confirm to delete the team.",-1)),gI={class:"buttons"};function mI(t,e,n,s,r,i){const o=$t("Button");return st(),It(He,null,[pI,ne("div",gI,[we(o,{label:"Confirm",onClick:i.deleteTeam},null,8,["onClick"]),we(o,{label:"Cancel",onClick:i.handleCancel,type:"cancel"},null,8,["onClick"])])],64)}const yI=bn(fI,[["render",mI],["__scopeId","data-v-7ecd958b"]]);const vI={components:{Button:ec,Team:Vy,SearchBar:Ky,AddForm:J1,Modal:nI,ConfirmDelete:yI},data(){return{allTeams:[],deleteDoc:null,teamName:"",loaded:!1}},mounted(){let t=Ep(ll,"teams");t=mT(t,yT("name")),bT(t,e=>{this.allTeams=[],e.docs.forEach(n=>{const s=n.id;n=n.data(),n.id=s,this.allTeams.push(n)})})},methods:{reset(){this.$refs.searchBar.$data.teamName="",this.teamName=""},handleTeamName(t){this.teamName=t},addTeam(){this.$refs.addForm.$el.showModal()},closeAddFrom(){this.$refs.addForm.$el.close(),ng.show("The team has been added successfully!")},closeAddModal(){this.$refs.addForm.$el.close()},askConfirm(t){this.$refs.deleteModal.$el.showModal(),this.deleteDoc=t},closeConfirmBox(){this.$refs.deleteModal.$el.close()},showTeams(){this.loaded=!0}},computed:{filteredTeam(){return this.allTeams.filter(t=>t.name.toLowerCase().includes(this.teamName.trim().toLowerCase()))}}},hl=t=>(ar("data-v-c7be95b3"),t=t(),cr(),t),wI={class:"container"},_I=hl(()=>ne("h1",null,"teams-titles",-1)),EI=hl(()=>ne("p",null,[ne("strong",null,"Built using:"),Zh(" Vue, Options API, HTML, CSS, Firebase, Snackbar.js, Vite ")],-1)),TI=hl(()=>ne("p",null," This fully-fledged Vue app allows users to view the winning history of top European football teams in the UEFA Champions League. Users can access the Champions League winning history of teams such as Real Madrid, Barcelona, Manchester United, Chelsea, Liverpool, Bayern Munich, AC Milan, Inter Milan, Juventus, Ajax, etc. Additionally, the app provides functionality for users to add new teams or remove existing ones. ",-1)),II={class:"app-functions"},bI={class:"all-teams"};function CI(t,e,n,s,r,i){const o=$t("SearchBar"),a=$t("Button"),c=$t("Team"),l=$t("AddForm"),u=$t("Modal"),f=$t("ConfirmDelete");return st(),It("div",wI,[_I,EI,TI,ne("div",II,[we(o,{ref:"searchBar",onUpdate:i.handleTeamName},null,8,["onUpdate"]),we(a,{label:"add a new team",onClick:i.addTeam},null,8,["onClick"]),we(a,{label:"reset",type:"reset",onClick:i.reset},null,8,["onClick"])]),ni(ne("div",bI,[(st(!0),It(He,null,$h(i.filteredTeam,(p,g)=>(st(),Yh(c,{onDelete:i.askConfirm,key:g,id:p.id,src:p.logo,name:p.name,winningYears:p.winningYears,onLoaded:i.showTeams},null,8,["onDelete","id","src","name","winningYears","onLoaded"]))),128))],512),[[Dy,r.loaded]]),we(u,{ref:"addForm"},{default:Wo(()=>[we(l,{onAdd:i.closeAddFrom,onClose:i.closeAddModal},null,8,["onAdd","onClose"])]),_:1},512),we(u,{ref:"deleteModal"},{default:Wo(()=>[we(f,{deleteDoc:r.deleteDoc,onCancel:i.closeConfirmBox,onConfirm:i.closeConfirmBox},null,8,["deleteDoc","onCancel","onConfirm"])]),_:1},512)])}const AI=bn(vI,[["render",CI],["__scopeId","data-v-c7be95b3"]]);Ry(AI).mount("#app");
